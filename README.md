...
🎓 **Systems Engineer** from **ICESI University** (Graduating August 2026 | GPA: 4.7/5.0).  
💼 Currently working at **Globant** as a **Test Automation / QA Engineer**.  
💡 Certified **Fabric Data Engineer Associate** passionate about **Data Engineering, Software Development, and AI**.  
🌎 **Bilingual:** Spanish & English (C1 Certified).  

---

## 🚀 About Me  
- 🛠️ **Full-Stack & QA Automation:** Experience migrating legacy systems to modern architectures (Spring Boot) and securing critical business flows with scalable automated testing scripts.
- 📊 **Data Engineering & AI:** Certified in Microsoft Fabric, building scalable data pipelines with **PySpark, Databricks, and Apache Airflow**.
- 🧠 **Problem Solver:** Driven by logic, continuous learning, and clean code architecture.
...
- 🏛️ **Software Architect Certification (Junior Level)** — Perficient
